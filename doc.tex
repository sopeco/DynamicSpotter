...
\Large{
\textbf{Alexander Wert}\\alexander.wert@kit.edu\\ Am
Fasanengarten 5\\
...
In this section we describe the architecture of \DS and introduce the project structure of the \DS code repository. 

\subsection{Architecture of \DS}
\begin{figure}[p]
