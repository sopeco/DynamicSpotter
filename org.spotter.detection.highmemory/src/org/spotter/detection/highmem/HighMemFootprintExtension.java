...
/**
 * High Memory Usage detection extension.
 * 
 * @author Alexander Wert
 * 
 */
public class HighMemFootprintExtension extends AbstractDetectionExtension {
	...
	public String getName() {
		return "HighMemoryFootprint";
	}

	@Override
	public IDetectionController createExtensionArtifact() {
		return new HighMemFootprintDetectionController(this);
	}
